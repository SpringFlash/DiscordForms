...
1. В режиме редактора нажмите **"Сгенерировать ссылку для шаринга"**
2. Появится поле с уникальной ссылкой для вашей формы
3. Нажмите **"Копировать"** чтобы скопировать ссылку в буфер обмена
4. Отправьте ссылку людям - они увидят вашу настроенную форму в режиме просмотра
5. Все заполненные формы будут приходить в ваш Discord канал как красивые embed сообщения

**Примечание**: Ссылка содержит всю конфигурацию формы в зашифрованном виде
